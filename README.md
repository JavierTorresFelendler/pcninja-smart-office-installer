...
The current stable release is `v3.3.8`, with Windows file version `3.3.8.0`.
...
Verified stable `v3.3.8` SHA256:

```text
987015d25dca377becdc69ab9182ea8576ff1082e522383b7c4bb40954a31957
```
